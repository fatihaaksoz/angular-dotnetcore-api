...
constructor(private httpClient:HttpClient , private route:Router ,private alertifyService:AlertifyService) { }

path:string="http://localhost:51144/api/auth"
userToken:any;
decodedToken:any;
...
TOKEN_KEY = 'token';
  ...
  register(registerUser:RegisterUser){
    ...
    this.httpClient.post(this.path + "/register",registerUser,{headers:headers}).subscribe(data=>{
      this.alertifyService.success("Sisteme başarıyla kayıt oldunuz.")
      this.route.navigateByUrl('/city');
    });
